...
const numbers = [
  {
    ...
    context: 'Two-year average against a $900K mid-market quota at Samsara (FY24, FY25)',
    prefix: '',
    number: 118,
    suffix: '%',
    decimals: 0,
  },
  {
    ...
    context: 'Single deal closed by reframing the buyer\u2019s risk and securing CFO alignment early',
    prefix: '$',
    number: 250,
    suffix: 'K',
    decimals: 0,
  },
  {
    value: '55%+',
    label: 'Self-Sourced',
    context: 'Pipeline built through targeted outbound. Top 5 regionally in pipeline generation',
    prefix: '',
    number: 55,
    suffix: '%+',
    decimals: 0,
  },
  {
    value: '8 Years',
    label: 'Market Tenure',
    context: 'Across insurtech, operational SaaS, and fleet IoT',
    prefix: '',
    number: 8,
    suffix: ' Years',
    decimals: 0,
